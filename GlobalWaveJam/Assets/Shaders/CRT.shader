//Based on gamasutra.com/blogs/SvyatoslavCherkasov/20140531/218753/Shader_tutorial_CRT_emulation.php
Shader "Custom/CRT" 
{
    Properties {
    ...
    SubShader {
        Pass {
            ...
            half4 frag(v2f i): COLOR
            {
                ...
                if ((int)ps.y % 3 == 0) color *= float4(_ScanColor, _ScanColor, _ScanColor, 1);
